...
```powershell
cd C:\Workspace_local\foundation-public
...
- gitleaks allowlist
- Launcher ou decryption pipeline

**Método**: Generar nuevo .exe y reinstalar

```powershell
# En desarrollo (foundation-public)
cd C:\Workspace_local\foundation-public

# 1. Encriptar scripts actualizados
$env:FOUNDATION_BASE_DIR='c:\Workspace_local\foundation-public'
